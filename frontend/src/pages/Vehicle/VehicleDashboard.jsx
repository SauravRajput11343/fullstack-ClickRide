...
export default function VehicleDashboard() {
    ...
    // Sort vehicles by the most recently added (assuming there's a 'createdAt' field)
        ...
        <div>
            ...
            >
                ...
                <div className="mt-6 grid  sm:grid-cols-2 lg:grid-cols-5  gap-4 p-5">
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 h-[600px] overflow-y-auto scrollbar-hide shadow-xl">
                        {/* Heading Row */}
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-2 bg-white h-[600px] rounded-xl shadow-2xl overflow-y-scroll scrollbar-hide">
                        ...
                        <div className="bg-white  lg:col-span-4 md:col-span-4 rounded-xl shadow-2xl overflow-y-scroll scrollbar-hide">
                            ...
                            {vehicleDetails && vehicleDetails.length > 0 ? (
                                // Sort vehicles by createdAt in descending order and slice the first 10
                                vehicleDetails
                                    ...
                                    .map((vehicle, index) => (
                                        <div
                                            key={index}
                                            role="button"
                                            onClick={() => handleViewVehicleDetails(vehicle._id)} // Pass vehicle._id to the next page
